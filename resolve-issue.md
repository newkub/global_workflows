---
title: Resolve Issue
description: แก้ไขปัญหาทั่วไปอย่างเป็นระบบ (code, content, docs, config, workflows)
...
แก้ไขปัญหาอย่างเป็นระบบ ไม่ว่าจะเป็น code, content, documentation, configuration, หรือ workflows
...
ยืนยันการแก้ไขและรายงานผล

1. ทดสอบว่าแก้ปัญหาได้จริง
2. ตรวจสอบ side effects
3. ทำ `/report-review` เพื่อสรุปผลการแก้ไข
...
- รายงานผลการแก้ไขผ่าน `/report-review`
