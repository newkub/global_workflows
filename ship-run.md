...
อ่าน workflows ที่เกี่ยวข้องก่อนเริ่ม ship

- ทำตาม `rules/read-workflows-before-work.md` เพื่ออ่าน workflows ที่เกี่ยวข้องก่อนเริ่มทำงาน
...
### 4. Verify Test Quality (Optional)
