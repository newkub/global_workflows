...
ใช้ format มาตรฐานสำหรับ TODO comments ตามภาษา

- `// TODO: [priority] [category]: description` สำหรับ single-line (C-style)
- `/* TODO: [priority] [category]: description */` สำหรับ multi-line (C-style)
- `<!-- TODO: [priority] [category]: description -->` สำหรับ HTML/XML
- `# TODO: [priority] [category]: description` สำหรับ Python/Shell/Markdown
- `-- TODO: [priority] [category]: description` สำหรับ Lua/SQL
- `(* TODO: [priority] [category]: description *)` สำหรับ ML/F#
- `(* TODO: [priority] [category]: description *)` สำหรับ Haskell
