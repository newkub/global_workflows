...
1. ทำ `/analyze-project` เพื่อวิเคราะห์โครงสร้างโปรเจกต์
2. ตรวจสอบไฟล์ที่ยาวกว่า 250 บรรทัด
3. ตรวจสอบไฟล์ที่มีหลาย responsibilities
4. ตรวจสอบไฟล์ที่ไม่อยู่ในตำแหน่งที่เหมาะสม
5. ระบุไฟล์ที่ต้อง refactor
