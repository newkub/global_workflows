...
| Category | Workflows |
|----------|-----------|
| **Project Analysis** | `/analyze-project`, `/deep-analyze`, `/check-file-structure` |
...
| **DDD** | `/follow-ddd` |
| **Microservices** | `/follow-microservices` |
...
| **Rust** | `/follow-rust` |
| **Bun** | `/follow-bun`, `/follow-bun-native` |
...
2. Follow `/follow-write-workflows` for workflow structure
