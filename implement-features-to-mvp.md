...
2. ระบุ MVP requirements จาก business goals
3. สร้าง MVP checklist ที่ชัดเจน
4. ตรวจสอบว่า requirements สอดคล้องกับ timeframe
...
- ❌ ทำทุก features พร้อมกันโดยไม่จัดลำดับ
- ❌ เพิ่ม optional features ใน MVP
- ❌ Over-engineer solutions สำหรับ MVP
- ❌ ไม่หยุดเมื่อ MVP ครบถ้วน
- ❌ เพิ่ม scope โดยไม่ประเมิน impact
