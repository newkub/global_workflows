...
4. ทำ `/refactor-long-files-to-single-responsibility` สำหรับไฟล์ > 250 บรรทัด
5. ทำ `/refactor-file-to-single-responsibility` สำหรับ modules ที่ใหญ่เกินไป
6. ทำ `/relocation` เฉพาะไฟล์ที่ split ออกมาใหม่จาก logical refactoring
7. ทำ `/improve-naming` เพื่อปรับปรุง naming conventions
8. ทำ `/use-scripts` สำหรับ file operations จำนวนมาก
