...
4. ทำ `/analyze-code-structure` เพื่อดูโครงสร้างไฟล์และ folders
5. ทำ `/analyze-codebase-quality` เพื่อระบุ SRP, SoC, type safety, anti-patterns, code smells, dead code, side effects, naming conventions
