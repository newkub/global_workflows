...
ทำ `/analyze-codebase-quality` สำหรับ comprehensive analysis ครบทุกด้าน

1. ทำ `/analyze-codebase-quality` วิเคราะห์ codebase ครบทุกด้าน ผ่าน analyze-code-* sub-workflows
2. ทำ `/deep-review` สำหรับ comprehensive review ครบทุกมิติ พร้อม severity ratings
3. รวบรวม findings ทั้งหมดจาก `/analyze-codebase-quality` และ `/deep-review`
