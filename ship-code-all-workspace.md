---
title: Ship Code All Workspace
description: Ship code ครบวงจรสำหรับทุก workspace ใน monorepo
auto_execution_mode: 3
---

## Goal

Ship code ครบวงจรสำหรับทุก workspace ใน monorepo อย่างเป็นระบบ
...
ทำ ship-code สำหรับแต่ละ workspace ตามลำดับ

1. ทำ `/each-workspaces` เพื่อดำเนินการกับแต่ละ workspace
2. ทำ `/ship-code` สำหรับแต่ละ workspace ที่ค้นพบ
3. ตรวจสอบว่าแต่ละ workspace ได้รับการประมวลผลครบถ้วน

### 3. Verify Completion

ตรวจสอบว่าทุก workspace ผ่านการ ship-code
...
- ทุก workspace ใน monorepo ได้รับการ ship-code ครบถ้วน
