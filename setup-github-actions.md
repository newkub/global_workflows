...
description: Setup GitHub Actions for CI/CD with comprehensive workflows
...
1. ทำ `/setup-renovate` เพื่อตั้งค่า dependency updates
2. ทำ `/setup-release-it` เพื่อตั้งค่า automated releases (ถ้าเป็น monorepo)
