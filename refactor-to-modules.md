...
description: Refactor code ให้เป็น modules ที่มี single responsibility และชัดเจน
...
1. ทำ `/separate-of-concern` เพื่อแยก logical concerns
2. ทำ `/refactor-file-to-single-responsibility` สำหรับ modules ที่ใหญ่เกินไป
3. ทำ `/relocation` เพื่อย้าย code ไปยัง modules ที่เหมาะสม
4. สร้าง barrel exports สำหรับแต่ละ module
5. ใช้ `/use-scripts` สำหรับ file operations จำนวนมาก

### 4. Merge Redundant Modules
