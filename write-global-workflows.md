...
1. ตรวจสอบว่าไฟล์ไม่เกิน 250 บรรทัด และทุก step มีเงื่อนไขการเสร็จชัดเจน (context rot mitigation)
2. ตรวจสอบว่ามี verification checks และ error handling สำหรับ execution steps (harness engineering)
3. ทำ `/improve-correctness` เพื่อตรวจสอบความถูกต้องของเนื้อหา
