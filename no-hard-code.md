...
1. ทำ `/setup-config` เพื่อสร้าง config files สำหรับ environment-specific values
...
1. ทำ `/follow-phase-dev` เพื่อใช้ environment variables สำหรับ secrets
...
2. ทำ `/review-code-and-fix` เพื่อ Review code อย่าง manual
