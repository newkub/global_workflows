...
### 5. Verify All Files Used

ตรวจสอบว่าทุกไฟล์ถูกใช้

1. ทำ `/run-lint` เพื่อตรวจสอบว่าไม่มี unused variables
2. ตรวจสอบว่าไม่มีไฟล์ที่ไม่ได้ใช้เหลือ
3. ถ้ามีไฟล์ที่ไม่ได้ใช้ ให้ลบหรือ implement ให้ครบ
4. ทำ `/loop-until-complete` จนกว่าทุกไฟล์จะถูกใช้
...
- คำแนะนำการดำเนินการ
- ความมั่นใจในการลบ
- ทุกไฟล์ถูกใช้ ไม่มีไฟล์ที่ไม่ได้ใช้เหลือ
