...
2. ทำ `/check-duplication`, `/check-unused-files`, `/check-unused-deps` แบบ parallel
...
1. ทำ `/follow-time-complexity` วิเคราะห์ time complexity ของ critical paths
2. วิเคราะห์ performance bottlenecks
3. ตรวจสอบ database queries และ N+1 problems
4. ตรวจสอบ caching strategies
5. ตรวจสอบ bundle size และ asset optimization
6. ตรวจสอบ rendering performance สำหรับ frontend
7. ระบุ optimization opportunities
