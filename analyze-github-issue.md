...
ใช้สำหรับ GitHub issues ที่ต้องการ analyze, triage, หรือ assess ก่อน assign หรือ fix
...
- แยกแยะระหว่าง analysis (workflow นี้) และ fix (`/fix-my-github-issue`)
- ห้ามแก้ไขโค้ดในขั้นตอน analysis เด็ดขาด
- ใช้ `/deep-review` สำหรับ script-based codebase scanning เพิ่มเติม
