...
4. ใช้ `/clean-architecture` ภายในแต่ละ module
...
- ทำ `/event-driven` หากใช้ pattern นี้
...
- ทำ `/clean-architecture` เพื่อ implement architecture ภายในแต่ละ module
- ทำ `/event-driven` หากใช้ async communication
- ทำ `/microservices` สำหรับ migration path ถัดไป
